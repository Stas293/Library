...
public class DisableUser implements ControllerCommand {
    private static final Logger LOGGER = LogManager.getLogger(DisableUser.class);
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            userService.disableUserById(userToDisable.getId());
        } catch (ServiceException e) {

            return Links.ADMIN_PAGE_REDIRECT_DISABLE_ACCOUNT_FAILED;
        }
        clearRequestSessionAttributes(request);
        return Links.ADMIN_PAGE_REDIRECT_DISABLE_ACCOUNT_SUCCESS;
    }
